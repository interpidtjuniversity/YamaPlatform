package com.clcy.grade_feedback.aspect;
...
public class LimitAspect {
    ...
    @Around("execution(public * *(..)) && @annotation(com.clcy.grade_feedback.annotation.Limit)")
    public Object interceptor(ProceedingJoinPoint pjp){
        ...
        switch (type){
            case IP:
                ...
                break;
            case IP_METHOD:
                key = getIpAddress() + StringUtils.upperCase(method.getName());
                break;
            default:
